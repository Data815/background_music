...
. Descriptive analysis:
  1) similar number of students for each gender; students finshed the test with background music in a longer time and the learning effect exist.
  2)male easily be impacted by music than other genders
  3)favouriblity of the background would influence the time
